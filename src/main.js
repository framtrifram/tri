...
const myBot = ['u5ace79eb21357bceec8014f5e5194e9b','u5a8f1f79740e3dc876a13ab7f7381340'];
...
\n";
        ...
        if(txt === 'ok' && this.stateStatus.kick == 1 && isAdminOrBot(seq.from_) && seq.toType == 2) {
            let { listMember } = await this.searchGroup(seq.to);
            for (var i = 0; i < listMember.length; i++) {
        ...
        }else if(txt === 'ok' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"Not permitted !");}
